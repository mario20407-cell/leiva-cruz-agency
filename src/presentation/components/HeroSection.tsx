  ...
  return (
    <section className="relative overflow-hidden min-h-[calc(100vh-80px)] flex items-center py-8 bg-[#0D0F12]">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10 w-full grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-center">
        ...
        {/* Columna Derecha: Logo Corporativo Completo (Logo escalado un 75% más grande) */}
        <div className="lg:col-span-5 flex justify-center items-center">
          <div className="relative w-72 h-72 sm:w-80 sm:h-80 bg-black border border-slate-800 rounded-full flex items-center justify-center p-4 shadow-2xl overflow-hidden">
